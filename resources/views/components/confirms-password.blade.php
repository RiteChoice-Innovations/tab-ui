...
<x-ui.dialog-modal wire:model.live="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}"
            ...
            <x-ui.input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Password') }}"
                autocomplete="current-password" x-ref="confirmable_password" wire:model="confirmablePassword"
                wire:keydown.enter="confirmPassword" />

            <x-ui.input-error for="confirmable_password" class="mt-2" />
        </div>
    </x-slot>
    ...
    <x-slot name="footer">
        ...
        <x-ui.button class="ms-3" dusk="confirm-password-button" wire:click="confirmPassword"
